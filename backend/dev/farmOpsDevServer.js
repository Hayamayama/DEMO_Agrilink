...
// No synced mandi prices in this in-memory database, so the dashboard shows the seeded snapshot.
const farmPriceService=createFarmPriceService({prices:createPriceService(pgRepo(pool)),cache:createPriceCacheRepository(pool)});
